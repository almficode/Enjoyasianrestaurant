...
const TRANSLATIONS = {
  en: {
    ...
    ai_gateway_text:  'Five AI-powered tools built exclusively for ENJOY — from a 24/7 multilingual dining assistant to a daily menu generator, pairing sommelier, occasion planner and sentiment dashboard.',
    ai_gw_icon1:      'Dining Assistant',
    ai_gw_icon2:      'Dish Finder',
    ai_gw_icon3:      'Menu Generator',
    ai_gw_icon4:      'Pairing AI',
    ai_gw_icon5:      'Occasion Planner',
    ai_gateway_btn:   '✦ Open AI Suite →',
  ...
  es: {
    ...
    ai_gateway_text:  'Cinco herramientas de IA creadas en exclusiva para ENJOY — desde un asistente gastronómico multilingüe 24/7 hasta un generador de menús diarios, sumiller de maridajes, planificador de ocasiones especiales y panel de opiniones.',
    ai_gw_icon1:      'Asistente Gastronómico',
    ai_gw_icon2:      'Buscador de Platos',
    ai_gw_icon3:      'Generador de Menús',
    ai_gw_icon4:      'IA de Maridajes',
    ai_gw_icon5:      'Planificador de Ocasiones',
    ai_gateway_btn:   '✦ Abrir Suite de IA →',
  ...
  de: {
    ...
    ai_gateway_text:  'Fünf KI-gestützte Tools, exklusiv für ENJOY entwickelt — von einem mehrsprachigen Restaurantassistenten 24/7 bis hin zu einem täglichen Menügenerator, Pairing-Sommelier, Anlassplaner und Stimmungs-Dashboard.',
    ai_gw_icon1:      'Restaurantassistent',
    ai_gw_icon2:      'Gerichte-Finder',
    ai_gw_icon3:      'Menü-Generator',
    ai_gw_icon4:      'Pairing-KI',
    ai_gw_icon5:      'Anlassplaner',
    ai_gateway_btn:   '✦ KI-Suite öffnen →',
  ...
  fr: {
    ...
    ai_gateway_text:'Cinq outils alimentés par l\'IA conçus exclusivement pour ENJOY — d\'un assistant culinaire multilingue 24/7 à un générateur de menus quotidiens, un sommelier d\'accords mets-vins, un planificateur d\'occasions et un tableau de bord des avis.',
    ai_gw_icon1:'Assistant Culinaire',ai_gw_icon2:'Chercheur de Plats',ai_gw_icon3:'Générateur de Menus',
    ai_gw_icon4:'IA d\'Accords',ai_gw_icon5:'Planificateur d\'Occasions',
    ai_gateway_btn:'✦ Ouvrir la Suite IA →',
